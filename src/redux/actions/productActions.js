...
import { ADMIN_PRODUCT_FAIL, ADMIN_PRODUCT_REQUEST, ADMIN_PRODUCT_SUCCESS, ALL_PRODUCT_FAIL, ALL_PRODUCT_REQUEST, ALL_PRODUCT_SUCCESS, ALL_REVIEW_FAIL, ALL_REVIEW_REQUEST, ALL_REVIEW_SUCCESS, CLEAR_ERROR, DELETE_PRODUCT_FAIL, DELETE_PRODUCT_REQUEST, DELETE_PRODUCT_SUCCESS, DELETE_REVIEW_FAIL, DELETE_REVIEW_REQUEST, DELETE_REVIEW_SUCCESS, NEW_PRODUCT_FAIL, NEW_PRODUCT_REQUEST, NEW_PRODUCT_SUCCESS, NEW_REVIEW_FAIL, NEW_REVIEW_REQUEST, NEW_REVIEW_SUCCESS, PRODUCT_DETAILS_FAIL, PRODUCT_DETAILS_REQUEST, PRODUCT_DETAILS_SUCCESS, UPDATE_PRODUCT_FAIL, UPDATE_PRODUCT_REQUEST, UPDATE_PRODUCT_SUCCESS } from '../actionTypes/productActionTypes';
...
export const getAdminProduct = () => async (dispatch) => {
    try {
        ...
        let link = `${server}/products/admin/products`;
        const { data } = await axios.get(link, { withCredentials: true })
...
export const createProduct = (productData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(`${server}/products/create`, productData, config)
...
export const getProductDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${server}/products/${id}`, { withCredentials: true })
...
export const updateProduct = (productData, id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`${server}/products/${id}`, productData, config)
...
export const getAllReviews = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${server}/products/admin/reviews?id=${id}`, { withCredentials: true });
...
export const deleteReviews = (reviewId, productId) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.delete(
            `${server}/products/admin/review?id=${reviewId}&productId=${productId}`, { withCredentials: true }
        );
